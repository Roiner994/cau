...
<script language="javascript">
	...
	function generarExcel(){			
			...
			window.open('../librerias/rptEquiposyComponentesDescontinuadosExcel.php?anno='+anno+"&mes="+meses+"&sitio="+sitio+"&gerencia="+gerencia);					
	}
	...
	function generarExcelResumido(){			
			...
			sitio=document.frmEquipo.sitio.value;			
			gerencia=document.frmEquipo.gerencia.value;			
			window.open('../librerias/rptEquiposyComponentesDescontinuadosResumidoExcel.php?anno='+anno+"&mes="+meses+"&sitio="+sitio+"&gerencia="+gerencia);					
	}
...
<?php 
	...
	echo "<table class=\"formularioTabla\"align=center width=\"500\" border=\"0\">";
		...
		echo "<tr>";
		echo "<td class=\"tituloPagina\" colspan=\"2\">INVENTARIO - REPORTE DE EQUIPOS Y COMPONENTES DESCONTINUADOS</td>
  				</tr>";
			echo "<tr>";
