...
function frmGarantia() {
	...
	$conDescripcion= "select distinct descripcion_id_descripcion,descripcion_descripcion from vistagarantia  where id_proveedor like '%$_POST[selProveedor]'order by descripcion";
	//Campo Proveedor
	...
	echo "<tr>
	<td valign=top class=\"formularioCampoTitulo\">PROVEEDORxxxxxxxxxxxxxxxx<br>$selProveedor<br>
	...
	echo "<tr>";
	echo "<td class=\"formularioTablaBotones\" colspan=\"2\"><input name=\"btnLimpiar\" type=\"button\" value=\"LIMPIAR\" onclick=\"location.href='index2.php?item=503'\">
	...
	$resultado=$garantia->retornarEquiposReportados($_POST[selStatus],$_POST[selProveedor],$_POST[txtSerial],$_POST[selDescripcion]);
