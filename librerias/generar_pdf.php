...
include 'connect.php';
$fecha=$_GET['fecha'];
$microcomputadoras=$_GET['microcomputadoras'];
$sql = "SELECT * FROM detalle_asistencias,usuario_sistema where fecha='$fecha' and mc='$microcomputadoras' and detalle_asistencias.id_trabajador=usuario_sistema.ID_USS";
...
<body>
	<table class="tabla_pdf">
		...
		<tr>
			...
			<td colspan="2"> Pedido/Contrato <br> N°4600007178</td>
		</tr>
		<tr>
