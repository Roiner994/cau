	...
	case 0:
		...
		if ((isset($_POST[txtFechaInicio]) && !empty($_POST[txtFechaInicio])) && (isset($_POST[txtFechaFinal]) && !empty($_POST[txtFechaFinal]))) {
			...
			if (compara_fechas($_POST[txtFechaFinal],$_POST[txtFechaInicio]) <0) {
					...
					echo "<table class=\"mensajeTitulo\" align=center width=\"500\" border=\"0\">";
					echo "<tr>";
					echo "<td align=center>MENSAJE:GARANTIA - REPORTES</td>
					</tr>";
					echo "<tr>";
		...
		break 1;
			default:
				...
				echo "<tr>";
				echo "<td valign=top class=\"mensaje\" align=center>SELECCIONE UN ".$mensaje. " </td>";
				echo "</tr>";
				echo "<tr>";
...
function formularioSeleccionarProveedor($buscar=0) {
require_once "conexionsql.php";
require_once "formularios.php";
...
FECHA FINAL<br>$txtFechaFinal<a href=\"javascript:show_calendar('frmGarantia.txtFechaFinal');\" onmouseover=\"window.status='Date Picker';return true;\" onmouseout=\"window.status='';return true;\"> <img src=\"../imagenes/calendario.gif\" width=\"23\" height=\"15\"></a><br>
	 	...
	 	echo "<tr>";
			echo "<td class=\"formularioTablaBotones\" colspan=\"2\"><input name=\"btnLimpiar\" type=\"button\" value=\"LIMPIAR\" onclick=\"location.href='secciones.php?item=502'\"><input name=\"Limpiar\" type=\"button\" value=\"BUSCAR\" onClick=\"buscar()\"></td>
...
if ($_POST[selStatus]==100) {
	...
	$garantiaI=$_POST[selProveedor];
		$despacho=new garantia("",$_POST[txtIdInventario],$_POST[selStatus],"","","","",$_POST[txtFechaInicio],$_POST[txtFechaFinal],$_POST[txtSerial],$_POST[selProveedor]);
		$resultado=$despacho->equipoGarantiaReportar() ;
		$total=$despacho->total();
		$row=mysql_fetch_array($resultado);
...
echo "<table width=\"700\" border=\"0\" align=\"center\">
		...
		echo "</table>";		
			echo "<table class=\"formularioTabla\"align=center width=\"700\" border=\"0\">";
			echo "<tr>";
			echo "<td class=\"formularioTablaBotones\" colspan=\"2\"><input name=\"btnLimpiar\" type=\"button\" value=\"IMPRIMIR\"onclick=window.open(\"../librerias/pdfGarantiaReportar.php?reporte=$_POST[selProveedor]&status=$_POST[selStatus]&fechaI=$_POST[txtFechaInicio]&fechaF=$_POST[txtFechaFinal]\")>
			</td> 								
	  		</tr>";
		...
		//echo "<table class=\"formularioTabla\"align=center width=\"700\" border=\"0\">";						
		 ...
		 echo "<form name=\"frmComponente\" method=\"post\" action=\"\">";
				...
				echo "<tr>";
				echo "<td valign=top class=\"mensaje\" align=center>NO EXISTEN REGISTROS EN ESE RANGO DE FECHA</td>";
				echo "</tr>";
