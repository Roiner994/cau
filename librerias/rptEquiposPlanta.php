...
<script type="text/javascript">
	...
	function generarReporte(idDescripcion) {		
		...
		window.open('../librerias/rptResumenEquiposPlanta.php?sitio='+sitio+'&idDescripcion='+idDescripcion+'&idMarca='+idMarca+'&idModelo='+idModelo+'&gerencia='+gerencia+'&txtConfiguracion='+txtConfiguracion+'&txtActivoFijo='+txtActivoFijo+'&txtSerial='+txtSerial+'&txtFicha='+txtFicha+'&fechaInicio='+fechaInicio+'$fechaFinal='+fechaFinal);	
	 ...
	 function generarExcel() {
		...
		window.open('../librerias/rptResumenEquiposPlantaExcel.php?sitio='+sitio+'&idDescripcion='+idDescripcion+'&idMarca='+idMarca+'&idModelo='+idModelo+'&gerencia='+gerencia+'&txtConfiguracion='+txtConfiguracion+'&txtActivoFijo='+txtActivoFijo+'&txtSerial='+txtSerial+'&txtFicha='+txtFicha+'&fechaInicio='+fechaInicio+'$fechaFinal='+fechaFinal);
...
function frmEquiposPlanta() {
	...
	$txtFechaFinal=$fechaFinal->retornar();
		...
		echo "<tr>";
		echo "<td class=\"tituloPagina\" colspan=\"2\">INVENTARIO DE EQUIPOS PLANTA</td>
	  	</tr>";
		...
		<input name=\"btnLimpiar\" type=\"button\" value=\"LIMPIAR\" onclick=\"location.href='index2.php?item=628'\"></td>			
		</tr>";		
		echo "</table>";
	...
	if ($_POST[selDescripcion]==100)
	 ...
	 $resultado=$rptEquipos->retornarInventarioEquipos($_POST[selSitio],$_POST[txtFechaInicio],$_POST[txtFechaFinal],$_POST[selGerencia],$_POST[selDescripcion],$_POST[txtActivoFijo],$_POST[txtFicha],$_POST[txtSerial],$_POST[txtConfiguracion],$_POST[selMarca],$_POST[selModelo],"ID_DESCRIPCION");
   ...
   echo "
		...
		<td valign=top class=\"tablaTitulo\"><b>CANTIDAD</b></td>		  
	 	...
	 	while ($row=mysql_fetch_array($resultado)) {
	 		...
	 		echo "<tr class=\"$clase\">";
	 		echo "<td align=\"left\"><a class=enlace href=\"#\" onclick=\"generarReporte('$row[8]')\"> $row[9]</a></td>";
