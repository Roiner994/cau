...
<script type="text/javascript">
	...
	function generarExcel() {
		...
		txtSerial=document.frmInventarioComponentes.txtSerial.value;		
		txtFicha=document.frmInventarioComponentes.txtFicha.value;		
		window.open('../librerias/rptResumenComponentesVidaUtilExcel.php?sitio='+sitio+'&idDescripcion='+idDescripcion+'&idGerencia='+gerencia+'&idMarca='+idMarca+'&idModelo='+idModelo+'&idPedido='+idPedido+'&idEstado='+idEstado+'&txtSerial='+txtSerial+'&txtFicha='+txtFicha);	
	}
...
function frmInventarioComponentes() {
	...
	$conEstado="select ID_ESTADO, ESTADO FROM inventario_estado where id_estado in ('EST0000001','EST0000002','EST0000003','EST0000004','EST0000005','EST0000006','EST0000007','EST0000008')ORDER BY ESTADO";
	...
	$txtFechaFinal=$fechaFinal->retornar();
		...
		echo "<tr>";
		echo "<td class=\"tituloPagina\" colspan=\"2\"> REPORTE DE VIDA UTIL DE COMPONENTES </td>
	  	</tr>";
	...
	echo "
		...
		<td valign=top class=\"tablaTitulo\"><b>CANTIDAD</b></td>		  
	 	...
	 	while ($row=mysql_fetch_array($resultado)) {
	 		...
	 		echo "<td align=\"center\">$row[55]</td>";
	 		echo "</tr>";
	 		$total=$total+$row[55];
	 		$i++;
	 	}
