			...
			case 0:
				...
				switch ($resultado) {
					...
					case 1:
						...
						echo "<tr>";
						echo "<td valign=top class=\"mensaje\" align=center>IMPOSIBLE GENERAR EL DESPACHO</td>";
						echo "</tr>";
						echo "<tr>";
...
function frmDespacho($elementos="",$quitar="") {
	...
	$conDescripcion="Select
		...
		descripcion
		Where
		descripcion.ID_DESCRIPCION_PROPIEDAD = 'DSP0000001'
		Order By
...
echo "<table class=\"formularioTabla\"align=center width=\"40%\" border=\"0\">";
	...
	echo "</table>";
			...
			echo "<table class=\"formularioTabla\"align=center width=\"70%\" border=\"0\">";
			echo "<tr>
			<td class=\"formularioTablaTitulo\" colspan=\"5\">INVENTARIO DISPONIBLE EN EL DEPOSITO</td>
			</tr>";	
			echo "<tr valign=top class=\"tablaTitulo\">
