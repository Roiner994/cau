...
*/		
		...
		switch($i) {
			case 0:
				...
				$nuevoEquipo->setInventario("",$_POST[txtSerial],$_POST[selDescripcion],$_POST[selMarca],$_POST[selModelo],$_POST[txtFru],$_POST[txtProductNumber],$_POST[txtSpareNumber],$_POST[txtCt],$_POST[selPedido],$_POST[txtFechaInicio],$_POST[txtFechaFinal],1,$login,$_POST[txtServiceTag],$_POST[txtExpressService]);
