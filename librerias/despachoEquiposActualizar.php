...
<script language="javascript">
	function cambiarSeleccionOtros() {
		...
		document.frmEquipo.cambiarSeleccion.value=1;
	...
	function buscarConfiguracionAnterior() {
		if (document.frmEquipo.txtConfiguracionAnterior.value!="") {
			document.frmEquipo.funcion.value=0;
			document.frmEquipo.cambiarConfiguracion.value=1;
			posicionamientoPantalla();
			document.frmEquipo.submit();
		} else {
			document.frmEquipo.txtSerialAnterior.value="";
			document.frmEquipo.txtActivoFijoAnterior.value="";
			document.frmEquipo.txtDescripcionAnterior.value="";
			document.frmEquipo.txtMarcaAnterior.value="";
			document.frmEquipo.txtModeloAnterior.value="";
		}
	}
	function buscarFicha() {
		if (document.frmEquipo.txtFicha.value!="") {
			...
			document.frmEquipo.txtNombres.value="";
			document.frmEquipo.txtCargo.value="";
			document.frmEquipo.txtExtension.value="";
			document.frmEquipo.selSitioUsuario.value=100;
...
switch ($funcion) {
	case 1:
		...
		switch ($i) {
			case 0:
				...
				$despacho->setDespacho($_GET[idDespacho],$login,$_POST[txtHelpDesk],1,"",$_POST[txtObservacion],$_POST[selSitio],$_POST[selDepartamento],$_POST[txtEspecifico],$_POST[txtFicha]);
				$despacho->setDetalleDespacho("",$_POST[txtConfiguracion],$_POST[txtConfiguracionAnterior],$_POST[selUsuarioSistema],$tipoAsignacion);
				$resultado=$despacho->actualizarDespacho();
				switch ($resultado) {
					case 0:
						$login=$_SESSION["login"];
						$nuevoEquipo=new equipo();
						//Ingresa Datos del Equipos
						$nuevoEquipo->setEquipo($_POST[txtConfiguracion],$_POST[txtActivoFijo],$_POST[chkCritico],$_POST[chkRed],$_POST[chkUsuarioEspecializado]);
						...
						if ($tipoAsignacion=='DEE0000005') {
							echo "<tr>";
							echo "<td valign=top class=\"mensaje\" align=center>SE ASIGNO EL EQUIPO.<br>ACTUALICE LOS DATOS DEL EQUIPO QUE REEMPLAZO.</td>";
							echo "</tr>";
							echo "<tr>";
							echo "<td valign=top class=\"mensaje\" align=center>
							<input name=\"btn\" type=\"button\" value=\"ACEPTAR\" onclick=\"location.href='index2.php?item=151&config=$_POST[txtConfiguracionAnterior]'\"></td>";
							echo "</tr>";
						} else {
							...
							$resultado=$requerimiento->cerrarRequerimientoEquipo($_POST[optInventario]);
							echo "<tr>";
							echo "<td valign=top class=\"mensaje\" align=center>SE ASIGNO EL EQUIPO</td>";
							echo "</tr>";
							echo "<tr>";
							echo "<td valign=top class=\"mensaje\" align=center>
							<input name=\"btn\" type=\"button\" value=\"ACEPTAR\" onclick=\"location.href='index2.php?item=622'\">";
							echo "<input name=\"btn\" type=\"button\" value=\"ENVIAR NOTIFICACION\" onclick=\"location.href='index2.php?item=635&configuracion=$_POST[txtConfiguracion]&nombre=$_POST[txtNombres]&ficha=$_POST[txtFicha]&extension=$_POST[txtExtension]'\"></td>";
							echo "</tr>";
						}
						echo "</table>";
						echo "</form>";	
	...
	case 2:
		$login=$_SESSION["login"];
			...
			$despacho->setDespacho($_GET[idDespacho],$login,$_POST[txtHelpDesk],1,"",$_POST[txtObservacion],$_POST[selSitio],$_POST[selDepartamento],$_POST[txtEspecifico],$_POST[txtFicha]);
			$despacho->setDetalleDespacho("",$_POST[txtConfiguracion],$_POST[txtConfiguracionAnterior],$_POST[selUsuarioSistema],$tipoAsignacion);
			$resultado=$despacho->deshacerAsignacion();
			...
			switch($resultado) {
				case 0:
					...
					echo "<tr>";
					echo "<td valign=top class=\"mensaje\" align=center>SE DESHIZO EL DESPACHO</td>";
					echo "</tr>";
					echo "<tr>";
					echo "<td valign=top class=\"mensaje\" align=center>
				...
				case 1:
					...
					echo "<tr>";
					echo "<td valign=top class=\"mensaje\" align=center>IMPOSIBLE DESHACER EL DESPACHO</td>";
					echo "</tr>";
					echo "<tr>";
					echo "<td valign=top class=\"mensaje\" align=center>
					<input name=\"btn\" type=\"submit\" value=\"ACEPTAR\"></td>";
...
function frmEquipoEquipos() {
	...
	if ($_POST[cambiarConfiguracion]!=1)
		if (isset($_GET[idDespacho]) && !empty($_GET[idDespacho])) {
			$despacho= new despachoEquipo();
			$despacho->setDespacho($_GET[idDespacho]);
			$resultadoDespacho=$despacho->buscarDespachoEquipos();
			if ($resultadoDespacho && $resultadoDespacho!=1) {
				$rowDespacho=mysql_fetch_array($resultadoDespacho);
				$_POST[txtConfiguracion]=$rowDespacho[13];
				$_POST[txtConfiguracionAnterior]=$rowDespacho[24];
				$_POST[txtFicha]=$rowDespacho[6];
				$_POST[selSitio]=$rowDespacho[35];
				$_POST[selGerencia]=$rowDespacho[37];
				$_POST[selDivision]=$rowDespacho[39];
				$_POST[selDepartamento]=$rowDespacho[41];
				$_POST[txtEspecifico]=$rowDespacho[43];
				$_POST[selUsuarioSistema]=$rowDespacho[48];
				$_POST[txtHelpDesk]=$rowDespacho[4];
				if($rowDespacho[46]=='DEE0000004')
					$_POST[chkPrestamo]=1;
				$_POST[txtObservacion]=$rowDespacho[45];	
			}
		}
	...
	echo "<td class=\"tituloPagina\" colspan=\"2\">DESPACHO DE EQUIPOS</td>
		...
		echo "<tr>
			...
			<input name=\"btnChequear\" title=\"Comprobar\" type=\"button\" value=\"BUSCAR\" onclick=\"modificarRequerimiento()\">
			<br>
			</td>
		...
		echo "<tr>
			...
			<a class=\"botonEnlace\" href=\"#\" onclick=\"deshacerDespacho()\">DESHACER DESPACHO</a>
			<a class=\"botonEnlace\" href=\"#\" onclick=\"generarDespacho()\">ASIGNAR <br>DESPACHO</a>
			</td>
		</tr>";	
	echo "</table>";
	echo "</form>";
