...
<script language="javascript">
	...
	function generarExcel(){			
			...
			window.open('../librerias/rptDespachosComp-EqExcel.php?anno='+anno+"&mes="+meses+"&sitio="+sitio+"&gerencia="+gerencia);					
	}
...
<?php 
	...
	echo "<table class=\"formularioTabla\"align=center width=\"500\" border=\"0\">";
		...
		echo "<tr>";
		echo "<td class=\"tituloPagina\" colspan=\"2\">DESPACHO - REPORTE DE DESPACHOS DE EQUIPOS Y COMPONENTES</td>
  				</tr>";
			echo "<tr>";
