	...
	$selDescripcion=$descripcion->retornar();
		...
		echo "</table>";
    		...
    		if ($_POST[validarboton]==1) {
				...
				$resultado=$rptComponentes->retornarFaltantesInventarioComponentes($_POST[selDescripcion],"componente_id_descripcion");
	 			...
	 			if ($resultado && $resultado!=1) {
						...
						<td valign=top class=\"tablaTitulo\"><b>CONFIGURACION</b></td>						
	 					...
	 					while ($row=mysql_fetch_array($resultado)) {
	 						...
	 						echo "<tr class=\"$clase\">";
	 						    echo "<td align=\"center\"><a class=enlace>$row[0]</a></td>";	 						    
	 						    echo "</tr>";
	 						    $total=$total+$row[1];
	 						    $i++;
