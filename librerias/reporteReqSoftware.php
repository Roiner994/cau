...
function buscarTotal() {
		document.frmRequrimientoSoftware.funcion.value=4;
		document.frmRequrimientoSoftware.submit();
	}
		...
		if ($anno2 > $anno1){			
			 formularioRequerimientoSoftware();
			  if ($_POST[selGerencia]==100 and $_POST[selDivision]==100){			 	
		         ...
		         $consulta="select distinct gerencia.gerencia,gerencia.id_gerencia,division.division,requerimiento_software.id_division,
			                requerimiento_software.id_software,tipo_software.tipo_software,software.software,sum(requerimiento_software.cantidad)
							...
							WHERE gerencia.id_gerencia like ('%$_POST[selGerencia]') and division.id_division like ('%$_POST[selDivision]') and requerimiento_software.fecha_inicio
							between '$fechaI' and '$fechaF' group by gerencia.gerencia,requerimiento_software.id_software";
		         ...
		         echo "<table class=\"formularioTabla\"align=center width=\"600\" border=\"0\">";					
						echo "<tr valign=top class=\"tablaTitulo\">
							...
							<td valign=top class=\"tablaTitulo\">SOFTWARE</td>							
		         ...
		         <input name=\"btnReporte\" type=\"button\" value=\"IMPRIMIR\"onclick=window.open(\"../librerias/pdfReportRequerimientoSoftware.php?gerencia=$_POST[selGerencia]&tipo=$_POST[selEstHardware]&fechaI=$fechaI&fechaF=$fechaF\")></td>";							 	
			   }
			   else{
			    echo "<form name=\"frmRequrimientoSoftware\" method=\"post\" action=\"\">";						
			    echo "<table class=\"mensajeTitulo\" align=center width=\"500\" border=\"0\">";
			 ...
			 $fechaF=substr($_POST[txtFechaFinal],6,4)."-". substr($_POST[txtFechaFinal],3,2)."-". substr($_POST[txtFechaFinal],0,2);			 			
	             $consulta="select distinct gerencia.gerencia,gerencia.id_gerencia,division.division,requerimiento_software.id_division,
						...
						inner join tipo_software on software.id_tipo_software=tipo_software.id_tipo_software
						WHERE gerencia.id_gerencia like ('%$_POST[selGerencia]') and division.id_division like ('%$_POST[selDivision]') and requerimiento_software.fecha_inicio
						between '$fechaI' and '$fechaF' group by gerencia.gerencia,division.division,requerimiento_software.id_software";		     	         
	         $result=mysql_query($consulta);
	         $resultado=mysql_num_rows($result);
	         if($resultado>0){
	         echo "<table class=\"formularioTabla\"align=center width=\"600\" border=\"0\">";					
	         ...
	         echo "<td class=\"formularioTablaBotones\" colspan=\"5\"><input name=\"btnCancelar\" type=\"button\" value=\"CANCELAR\" onclick=\"entrarDenuevo()\">
	         <input name=\"btnReporte\" type=\"button\" value=\"IMPRIMIR\"onclick=window.open(\"../librerias/pdfReportRequerimientoSoftware.php?gerencia=$_POST[selGerencia]&division=$_POST[selDivision]&tipo=$_POST[selEstHardware]&fechaI=$fechaI&fechaF=$fechaF\")></td>";							 	
			 }
			 else{			 	
			 	echo "<form name=\"frmRequrimientoSoftware\" method=\"post\" action=\"\">";						
				echo "<table class=\"mensajeTitulo\" align=center width=\"500\" border=\"0\">";
...
function totalGerencias(){
	...
	case 0:	
	 ...
	 $consulta="select distinct requerimiento_software.id_software,software.software,
				...
				and requerimiento_software.fecha_inicio between '$fechaI'
				and '$fechaF'
	...
	$result=mysql_query($consulta);
		     ...
		     $fechaF=substr($_POST[txtFechaFinal],6,4)."-". substr($_POST[txtFechaFinal],3,2)."-". substr($_POST[txtFechaFinal],0,2);			 			          	        
	           ...
	           <input name=\"btnReporte\" type=\"button\" value=\"IMPRIMIR\"onclick=window.open(\"../librerias/pdfReportRequerimientoSoftware.php?gerencia=$_POST[selGerencia]&division=$_POST[selDivision]&fechaI=$fechaI&fechaF=$fechaF\")></td>";							 	
	         }
	         else{
			    echo "<form name=\"frmRequrimientoSoftware\" method=\"post\" action=\"\">";						
			    echo "<table class=\"mensajeTitulo\" align=center width=\"500\" border=\"0\">";
...
$conGerencia= "SELECT distinct gerencia.ID_GERENCIA,gerencia.GERENCIA FROM GERENCIA
			   ...
			   INNER JOIN requerimiento_software on division.id_division=requerimiento_software.id_division";
$conDivision="SELECT distinct division.ID_DIVISION,DIVISION FROM DIVISION 
              INNER JOIN requerimiento_software on division.id_division=requerimiento_software.id_division WHERE ID_GERENCIA='$_POST[selGerencia]'";
...
echo "<form name=\"frmRequrimientoSoftware\" method=\"post\" action=\"\">";
	...
	echo "<tr>";
			echo "<td class=\"tituloPagina\" colspan=\"2\">REPORTE REQUERIMIENTO SOFTWARE</td>
  				</tr>";
		echo "<tr>";
...
FECHA INICIAL<br>$txtFechaInicio<a href=\"javascript:show_calendar('frmRequrimientoSoftware.txtFechaInicio');\" onmouseover=\"window.status='Date Picker';return true;\" onmouseout=\"window.status='';return true;\"> <img src=\"../imagenes/calendario.gif\" width=\"23\" height=\"15\"></a><br>
FECHA FINAL<br>$txtFechaFinal<a href=\"javascript:show_calendar('frmRequrimientoSoftware.txtFechaFinal');\" onmouseover=\"window.status='Date Picker';return true;\" onmouseout=\"window.status='';return true;\"> <img src=\"../imagenes/calendario.gif\" width=\"23\" height=\"15\"></a><br>
</td>
</tr>";
	 	echo "<tr>";
