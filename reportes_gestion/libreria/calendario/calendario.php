<script language="javascript" src="libreria/calendario/javascripts.js"></script>
<?
...
function mostrar_calendario($mes,$ano){
	...
	echo "<table width=190 cellspacing=0 cellpadding=0 border=0><tr><td colspan=7 align=center class=tit>";
	echo "<table width=70% cellspacing=0 cellpadding=0 border=0><tr><td style=font-size:04pt;font-weight:bold;color:white>";
	...
	echo "<a style=color:white;text-decoration:none href=index.php?$parametros_formulario&nuevo_mes=$mes_anterior&nuevo_ano=$ano_anterior>&lt;&lt;</a></td>";
	   ...
	   echo "<td align=right style=font-size:04pt;font-weight:bold;color:white>";
...
function escribe_formulario_fecha_vacio($nombrecampo,$nombreformulario){
	global $raiz;
	   echo ".....".'\''. $raiz.'\',\''.$nombreformulario .'\',\''.$nombrecampo.'\'';
	echo '
	<table>
	<tr><td width="10"><INPUT name="'.$nombrecampo.'" size="10" readonly="true"><td>
	<td width="7"><input type=button value="ir a " onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')"></td></tr></table>
	';	
}	
