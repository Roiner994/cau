...
where id_proveedor 
like '%$_GET[selproveedor]%' 
group by id_pedido, id_descripcion ";
...
<td><a href='detalle_proveedor.php?idpedido=<?=$rowGerencia[ID_PEDIDO]?>&iddescripcion=<?=$rowGerencia[ID_DESCRIPCION]?>'><img src="../imagenes/lupas.jpg" width="23" height="15"style=border:0></a></td>
...
<p class="paginador"><?=$_pagi_navegacion?></p>
	...
	<a href="proveedorexcel.php?selproveedor=<?=$_GET[selproveedor]?>&amp;id_pedido">FORMATO EXCEL</a></p>