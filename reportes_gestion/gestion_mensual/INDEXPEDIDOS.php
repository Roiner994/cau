...
<div id="contenedor">
	...
	<div id="cuerpo">
	<h2>REPORTE DE PEDIDO POR COMPONENTES</h2>

	<br><br><br>
<form name="frmPedido" action="pedido_detalle.php"  method="GET">
<td colspan="2"><div align="center">
  <?php 
 
$conPedido="SELECT pedido.ID_PEDIDO,CONCAT(pedido.ID_PEDIDO,', ',proveedor.PROVEEDOR) AS PROV 
FROM pedido INNER JOIN proveedor ON (pedido.ID_PROVEEDOR=proveedor.ID_PROVEEDOR) ORDER BY ID_PEDIDO";    
