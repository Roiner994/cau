...
$conGerencia="select ID_DESCRIPCION,GERENCIA,ID_PEDIDO,ESTADO, DESCRIPCION,MARCA,MODELO,SERIAL    from vistacomponentes where id_descripcion='$_GET[iddescripcion]' and id_pedido='$_GET[selPedido]'"; 
...
<p class="paginador"><?=$_pagi_navegacion?></p>
    ...
    <a href="pedidodetalleexcel.php?idpedido=<?=$_GET[selPedido]?>&iddescripcion=<?=$_GET[iddescripcion]?>">FORMATO EXCEL</a></p>
