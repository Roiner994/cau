...
$conGerencia="select id_descripcion,descripcion,ID_PEDIDO, proveedor,date_format(fecha_inicio,'%d/%m/%Y') as Inicio,FECHA_INICIO from vistacomponentes  where id_pedido like '%$_GET[selPedido]%' group by id_pedido ";
...
<div id="cuerpo">		
<h2> PEDIDOS CON SUS COMPONENTES</h2>
<?php
...
<td><a href='detallepedido.php?selPedido=<?=$rowGerencia[ID_PEDIDO]?>&amp;ID_PEDIDO'><img src="../imagenes/lupas.jpg" width="23" height="15"style=border:0></a></td>
