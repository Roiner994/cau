...
$conGerencia="select id_pedido,PROVEEDOR,fecha_inicio,ID_PEDIDO,COUNT(*)as Cantidad, DESCRIPCION from vistainventarioequipos where FECHA_INICIO between '$_GET[txtFechaInicio]' and '$_GET[txtFechaFinal]'  group by id_descripcion "; 
