...
$conGerencia="select estado,UNIDAD,id_descripcion, id_pedido,Descripcion,marca,modelo,serial, date_format(fecha_Final,'%d/%m/%y') as Final  from vistacomponentes  where  id_descripcion='$_GET[idDescripcion]'and id_pedido='$_GET[id_pedido]'  ";
...
$_pagi_propagar = array( "idDescripcion","id_pedido");//No importa si son POST o GET
...
<p class="paginador"><?=$_pagi_navegacion?></p>
    ...
    <a href="detallenuevoingresoexcel.php?id_pedido=<?=$_GET[id_pedido]?>&id_descripcion=<?=$_GET[idDescripcion]?>">FORMATO EXCEL</a></p>
