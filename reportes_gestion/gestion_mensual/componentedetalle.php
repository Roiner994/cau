...
$conGerencia="select serial, GERENCIA, date_format(fecha_FINAL,'%d/%m/%y') as Fecha,division,departamento,cargo,concat(nombre_usuario, ' ', apellido_usuario)AS NOMBRE , descripcion,marca from vistacomponentes where SERIAL= '$_GET[txtserial]'  order by descripcion ";
...
<div id="cuerpo">		
<h5><center>MANTENIMIENTOS PREVENTIVOS </h5></center>
<?php
...
<p class="paginador"><?=$_pagi_navegacion?></p>
	...
	<a href="cuadroexcel.php?idgerencia=<?=$_GET[idgerencia]?>">FORMATO EXCEL</a></p>
