...
$conGerencia="select id_descripcion, MARCA,SERIAL,MODELO,Descripcion,COUNT(*) AS cantidad, date_format(fecha_Final,'%d/%m/%y') as Final  from vistacomponentes  where  id_descripcion='$_GET[idDescripcion]' GROUP by  DESCRIPCION";
...
while ($rowGerencia=@mysql_fetch_array($_pagi_result)){
	...
	<tr>
     ...
     <td><a href='detalle.php?selpedido=<?=$_GET[selPedido]?>&idDescripcion=<?=$rowGerencia[ID_DESCRIPCION]?>'><img src="../imagenes/lupas.jpg" width="23" height="15"style=border:0></a></td>
