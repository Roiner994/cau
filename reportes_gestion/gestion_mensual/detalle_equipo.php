...
$conGerencia="select ID_DESCRIPCION,configuracion,activo_fijo,gerencia,ID_PEDIDO,ESTADO, DESCRIPCION,MARCA,MODELO,SERIAL    from vistainventarioequipos where id_descripcion='$_GET[iddescripcion]' and ID_PEDIDO='$_GET[selPedido]'"; 
...
$_pagi_propagar = array( "iddescripcion","selPedido");//No importa si son POST o GET
...
<p class="paginador"><?=$_pagi_navegacion?></p>
    ...
    <a href="detallesequiposexcel.php?selPedido=<?=$_GET[selPedido]?> &iddescripcion=<?=$_GET[iddescripcion]?>">FORMATO EXCEL</a></p>
