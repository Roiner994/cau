...
ID_PEDIDO,proveedor,descripcion,COUNT(*) AS cantidad, serial from vistacomponentes where  ID_PEDIDO like '%$_GET[selPedido]%' group by ID_descripcion,descripcion";
...
while ($rowGerencia=@mysql_fetch_array($_pagi_result)){
	...
	<tr>
    <td><a href='detalle.php?selPedido=<?=$_GET[selPedido]?>&iddescripcion=<?= $rowGerencia[ID_DESCRIPCION]?>'><img src="../imagenes/lupas.jpg" width="20" height="15"border="0"></a></td>
