...
$conGerencia="select ID_DESCRIPCION,SITIO,GERENCIA,ESTADO,ID_PEDIDO,ESTADO, DESCRIPCION,MARCA,MODELO,SERIAL    from vistainventarioequipos where  id_pedido='$_GET[idpedido]' and ID_DESCRIPCION='$_GET[iddescripcion]'"; 
...
<p class="paginador"><?=$_pagi_navegacion?></p>
    ...
    <a href="detalleproveedorexcel.php?id_pedido=<?=$_GET[idpedido]?>&iddescripcion=<?=$_GET[iddescripcion]?>">FORMATO EXCEL</a></p>
