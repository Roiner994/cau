...
$conFecha="select DATE_FORMAT(fecha_inicio, '%Y') as fecha 
	from vistamantenimientospreventivos 
	group by fecha order by fecha desc";

$consulta="select id_gerencia,
	gerencia,
	count(*) as cantidad 
	FROM vistamantenimientospreventivos 
	WHERE ID_SITIO<>'SIT0000057' and DATE_FORMAT(fecha_inicio, '%Y')='2006' group by id_gerencia order by gerencia";
conectarMysql();
